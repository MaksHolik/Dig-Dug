...
class Player extends Characters {
    // keys: {
    //   leftArrow: { pressed: boolean };
    //   rightArrow: { pressed: boolean };
    //   upArrow: { pressed: boolean };
    //   downArrow: { pressed: boolean };
    // };
    newKeys: {
        pressed: boolean;
    };
    ...
    movePlayer = () => {
      window.addEventListener("keydown", (event) => {
        ...
        window.addEventListener("keyup", (event) => {
          if(event.key == this.lastKey) clearInterval(this.interval);
